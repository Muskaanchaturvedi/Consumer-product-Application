package com.example.consumerproductproject.Services;
...
public class CategoryServiceTest {
    @Mock
    private com.example.consumerproductproject.Repository.CategoryRepo CategoryRepo;
    @InjectMocks
    private com.example.consumerproductproject.Service.CategoryService CategoryService;
    @Before
    public void setup() {
